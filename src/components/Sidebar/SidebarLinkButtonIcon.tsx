...
export function SidebarLinkButtonIcon({
  ...
  function linkClass(hrefLink: string) {
    return pathname.startsWith(hrefLink)
      ...
      : "flex items-center font-bold text-[#737791] justify-center gap-3 p-2 lg:p-4 text-sm lg:text-md hover:bg-primary-foreground hover:opacity-80 hover:text-white rounded-lg w-full md:max-w-[150px] lg:max-w-[200px] hover:font-bold";
  }
